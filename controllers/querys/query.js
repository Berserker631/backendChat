const querys = {
  ...
  getConversation: "SELECT * FROM  Conversations WHERE SessionID = @Session ORDER BY TimeReceived ASC",
  countMessages:
  ...
  RegisterUser:"INSERT INTO [DB_CHAT].[dbo].[Login] ([UserName], [Status], [Type], [Password], [CreationDate] )VALUES (@userName, @status, @type, @password, CURRENT_TIMESTAMP)",
    getAllUsers: "SELECT U.idUser, U.userName, U.alias, U.isActiveLog FROM db_erp.delivery.[user] AS U",
  // getAllUsers:
